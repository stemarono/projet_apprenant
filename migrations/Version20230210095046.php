 ...
 */
final class Version20230210095046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom_id INT DEFAULT NULL, DROP nom, DROP prenom, DROP identifiant');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom VARCHAR(20) DEFAULT NULL, ADD prenom VARCHAR(20) DEFAULT NULL, ADD identifiant VARCHAR(50) DEFAULT NULL, DROP nom_id');
    }
}
