 ...
 */
final class Version20230210102428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom_id INT DEFAULT NULL, DROP nom, DROP identifiant, CHANGE prenom prenom VARCHAR(20) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom VARCHAR(20) DEFAULT NULL, ADD identifiant VARCHAR(50) DEFAULT NULL, DROP nom_id, CHANGE prenom prenom VARCHAR(20) DEFAULT NULL');
    }
}
