 ...
 */
final class Version20230202144609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pre_inscription (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(20) DEFAULT NULL, prenom VARCHAR(20) DEFAULT NULL, date_naissance DATE DEFAULT NULL, sexe VARCHAR(10) DEFAULT NULL, adresse VARCHAR(100) DEFAULT NULL, code_postal INT DEFAULT NULL, ville VARCHAR(50) DEFAULT NULL, region VARCHAR(50) DEFAULT NULL, pays VARCHAR(50) DEFAULT NULL, telephone VARCHAR(50) NOT NULL, email VARCHAR(50) DEFAULT NULL, motivations VARCHAR(255) DEFAULT NULL, financement VARCHAR(255) DEFAULT NULL, carte_identite VARCHAR(255) DEFAULT NULL, justif_financement VARCHAR(255) DEFAULT NULL, carte_vitale VARCHAR(255) DEFAULT NULL, autre_doc VARCHAR(255) DEFAULT NULL, n_ss VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE formation ADD parcours_id INT DEFAULT NULL, CHANGE contenu contenu VARCHAR(1000) DEFAULT NULL');
        $this->addSql('ALTER TABLE formation ADD CONSTRAINT FK_404021BF6E38C0DB FOREIGN KEY (parcours_id) REFERENCES parcours (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_404021BF6E38C0DB ON formation (parcours_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_404021BF6E38C0DB ON formation');
        $this->addSql('ALTER TABLE formation DROP parcours_id, CHANGE contenu contenu VARCHAR(255) DEFAULT NULL');
    }
}
